...
inline bool all_positive(double num1, double num2, double num3) { return (num1 > 0) && (num2 > 0) && (num3 > 0); }
inline bool all_negative(double num1, double num2, double num3) { return (num1 < 0) && (num2 < 0) && (num3 < 0); }
